        ...
        <div className="footer">
            <div className="footerList">
                <ul>
                    ...
                    <li className="footerListItem">Places of interest</li>
                </ul>
                <ul>
                    ...
                    <li className="footerListItem">B&Bs</li>
                ...
                <ul>
                    ...
                    <li className="footerListItem">About Booka.com</li>
                    ...
                    <li className="footerListItem">Partner dispute</li>
                    <li className="footerListItem">How We Work</li>
                    <li className="footerListItem">Privacy & cookie statement</li>
                    <li className="footerListItem">Manage cookie settings</li>
                    <li className="footerListItem">Corporate contact</li>
                </ul>
            </div>
            <div className="footerText">
                Copyright © 1996–2022 Booka.com™. All rights reserved.
            </div>
        </div>
    )
}
